...
const testimonials = [
  {
    ...
    content:
      "A Resumefy is a web-based tool that allows users to create and customize a professional resume to their desired specifications. Have fun making your resume and get a job.",
    avatar:
      "",
  },
];
...
export default function About() {
  return (
    <>
      <Helmet>
        <title>About Us - ResumeFy</title>
        <meta
          name="description"
          content="Learn more about the ResumeFy website and its mission to provide easy-to-use tools for creating professional resumes."
        />
        <meta
          name="keywords"
        ...
        <meta property="og:title" content="About Us - ResumeFy " />
        <meta
